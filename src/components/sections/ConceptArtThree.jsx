...
const ConceptArtThree = () => {
    ...
    return (
        <div ref={sectionRef} className='w-screen h-lvh relative bg-[linear-gradient(to_bottom,rgba(0,0,0,0)_0%,rgba(17,17,17,0.4)_90%,rgba(17,17,17,0.6)_100%),url("/images/red_background.webp")]'>
            ...
            <div ref={containerRef} className='flex flex-col justify-center items-center h-full w-full overflow-hidden'>
                <img src='./images/character_art.webp' className=' max-h-full py-[3%]' />
            </div>
